  ...
  <div class="px-6 py-8 max-w-6xl mx-auto">
    <div class="flex items-start gap-4 mb-6">
      <div class="inline-flex items-center gap-2">
        <div class="w-12 h-12 text-base bg-brand-600 rounded-full flex items-center justify-center text-white font-medium flex-shrink-0">{{ initials }}</div>
      </div>
      <div class="flex-1 min-w-0">
        <div class="text-sm text-ink-500">{{ greeting }},</div>
        <h1 class="text-2xl font-semibold text-ink-900 mt-0.5">{{ userName }}</h1>
        <p class="text-sm text-ink-500 mt-1.5">Here is a snapshot of system activity today.</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
      <section class="lg:col-span-2 bg-white border border-ink-200 rounded-lg overflow-hidden">
        <header class="px-5 py-3 bg-gradient-to-r from-brand-50 to-white border-b border-ink-100 flex items-center justify-between">
          ...
          <span class="text-[10px] uppercase tracking-wider font-medium text-success-700 bg-success-50 px-2 py-0.5 rounded-full inline-flex items-center gap-1">
        ...
        <div class="p-5">
          <div class="grid grid-cols-2 sm:grid-cols-4 gap-5">
            <div>
              <div class="w-11 h-11 rounded-lg flex items-center justify-center mb-3 bg-brand-50 text-brand-700">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"></path><path d="M12 11h4"></path><path d="M12 16h4"></path><path d="M8 11h.01"></path><path d="M8 16h.01"></path></svg>
              </div>
              <div class="text-3xl font-semibold text-ink-900 tabular-nums leading-none">{{ showCount(activeProjectsCount, 4) }}</div>
              <div class="text-[10px] uppercase tracking-wider text-ink-500 font-medium mt-2">Active projects</div>
            </div>
            <div>
              <div class="w-11 h-11 rounded-lg flex items-center justify-center mb-3 bg-info-50 text-info-700">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
              </div>
              <div class="text-3xl font-semibold text-ink-900 tabular-nums leading-none">{{ showCount(openTasksCount, 9) }}</div>
              <div class="text-[10px] uppercase tracking-wider text-ink-500 font-medium mt-2">Open tasks</div>
            </div>
            <div>
              <div class="w-11 h-11 rounded-lg flex items-center justify-center mb-3 bg-success-50 text-success-700">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M14 19a6 6 0 0 0-12 0"></path><circle cx="8" cy="9" r="4"></circle><path d="M22 19a6 6 0 0 0-6-6 4 4 0 1 0 0-8"></path></svg>
              </div>
              <div class="text-3xl font-semibold text-ink-900 tabular-nums leading-none">{{ showCount(usersCount, 7) }}</div>
              <div class="text-[10px] uppercase tracking-wider text-ink-500 font-medium mt-2">Users</div>
            </div>
            <div>
              <div class="w-11 h-11 rounded-lg flex items-center justify-center mb-3 bg-warning-50 text-warning-700">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect width="7" height="7" x="3" y="3" rx="1"></rect><rect width="7" height="7" x="14" y="3" rx="1"></rect><rect width="7" height="7" x="14" y="14" rx="1"></rect><rect width="7" height="7" x="3" y="14" rx="1"></rect></svg>
              </div>
              <div class="text-3xl font-semibold text-ink-900 tabular-nums leading-none">{{ showCount(workspacesCount, 11) }}</div>
              <div class="text-[10px] uppercase tracking-wider text-ink-500 font-medium mt-2">Workspaces</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <RouterLink to="/settings" class="bg-brand-50 hover:bg-brand-100 rounded-lg p-5 flex flex-col justify-between transition-colors group">
        <div class="flex items-start gap-3">
          ...
          <div class="min-w-0">
            <h2 class="text-base font-semibold text-ink-900 leading-tight">Settings</h2>
            <p class="text-xs text-ink-600 mt-1.5 leading-snug">Manage workspaces, users, project types, and data.</p>
          </div>
        </div>
        <div class="mt-4 inline-flex items-center gap-1.5 bg-brand-600 group-hover:bg-brand-700 text-white text-xs font-medium px-2.5 py-1.5 rounded-md self-start transition-colors">Open Settings <span aria-hidden="true">→</span></div>
      </RouterLink>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-6">
      <RouterLink to="/sco" class="bg-white border border-ink-200 hover:border-brand-400 rounded-lg p-4 flex items-center gap-3 transition-colors group">
        ...
        <div class="flex-1 min-w-0">
          ...
          <div class="text-xs text-ink-500 mt-0.5 truncate">{{ showCount(pendingScosCount, 2) }} awaiting approval</div>
        </div>
      ...
      <RouterLink to="/tasks" class="bg-white border border-ink-200 hover:border-brand-400 rounded-lg p-4 flex items-center gap-3 transition-colors group">
        ...
        <div class="flex-1 min-w-0">
          ...
          <div class="text-xs text-ink-500 mt-0.5 truncate">{{ showCount(overdueTasksCount, 4) }} past their end date</div>
        </div>
        <div class="text-xs text-brand-700 group-hover:text-brand-800 font-medium flex-shrink-0">View →</div>
      </RouterLink>
      ...
      <RouterLink to="/progress-entries" class="bg-white border border-ink-200 hover:border-brand-400 rounded-lg p-4 flex items-center gap-3 transition-colors group">
        ...
        <div class="flex-1 min-w-0">
          ...
          <div class="text-xs text-ink-500 mt-0.5 truncate">{{ progressTodayCount ? `${progressTodayCount} entries filed` : 'No entries filed yet' }}</div>
        </div>
        <div class="text-xs text-brand-700 group-hover:text-brand-800 font-medium flex-shrink-0">View →</div>
      </RouterLink>
    </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        ...
        >
          <div class="w-10 h-10 rounded-lg bg-ink-50 group-hover:bg-brand-50 text-ink-600 group-hover:text-brand-700 flex items-center justify-center flex-shrink-0 transition-colors">
            <svg v-if="action.icon === 'users'" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M14 19a6 6 0 0 0-12 0"></path><circle cx="8" cy="9" r="4"></circle><path d="M22 19a6 6 0 0 0-6-6 4 4 0 1 0 0-8"></path></svg>
            <svg v-else-if="action.icon === 'companies'" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z"></path><path d="M6 12H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2"></path><path d="M18 9h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-2"></path><path d="M10 6h4"></path><path d="M10 10h4"></path><path d="M10 14h4"></path><path d="M10 18h4"></path></svg>
            <svg v-else-if="action.icon === 'project-types'" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><path d="M12 16v-4"></path><path d="M12 8h.01"></path></svg>
            <svg v-else-if="action.icon === 'workspace-structure'" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect width="7" height="7" x="3" y="3" rx="1"></rect><rect width="7" height="7" x="14" y="3" rx="1"></rect><rect width="7" height="7" x="14" y="14" rx="1"></rect><rect width="7" height="7" x="3" y="14" rx="1"></rect></svg>
            <svg v-else-if="action.icon === 'projects'" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"></path><path d="M12 11h4"></path><path d="M12 16h4"></path><path d="M8 11h.01"></path><path d="M8 16h.01"></path></svg>
            <svg v-else width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" x2="8" y1="13" y2="13"></line><line x1="16" x2="8" y1="17" y2="17"></line><line x1="10" x2="8" y1="9" y2="9"></line></svg>
          </div>
          <div class="flex-1 min-w-0"><div class="text-sm font-medium text-ink-900 group-hover:text-brand-700 transition-colors">{{ action.label }}</div></div>
