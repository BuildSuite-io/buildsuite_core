    ...
    <header class="h-14 border-b border-ink-200 px-4 sm:px-6 flex items-center gap-3 sm:gap-4">
      ...
      <div class="flex-1 flex justify-center">
        <div class="relative w-full max-w-xl">
          ...
          />
          <span class="absolute right-3 top-1/2 -translate-y-1/2 text-[10px] text-ink-400 font-medium hidden sm:inline tracking-wide">Ctrl+K</span>
        </div>
      </div>
      ...
      <div class="w-full max-w-5xl mx-auto">
        <div class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-x-4 gap-y-8">
          ...
          >
            ...
            <span class="text-sm font-medium text-ink-900 text-center leading-tight">{{ tile.label }}</span>
          </RouterLink>
        </div>
      </div>
    </main>
