  ...
  <div class="px-6 py-10">
    <div class="max-w-3xl mx-auto">
      ...
      <div v-if="links.length" class="mb-6">
        <div class="text-[11px] uppercase tracking-wider text-ink-500 font-semibold mb-2">Module shortcuts</div>
      ...
      <div v-if="!links.length" class="px-4 py-3 bg-ink-50 border border-ink-200 text-xs text-ink-600" style="border-radius: 6px;">
        <div class="font-medium text-ink-700 mb-1">No shortcuts available</div>
        <p class="leading-relaxed">There are no shortcuts configured for this workspace yet.</p>
      </div>
    </div>
  </div>
</template>
