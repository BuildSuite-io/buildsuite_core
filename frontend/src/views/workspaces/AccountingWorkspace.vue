...
const shortcuts = [
  ...
  { label: 'Journal Entry',       icon: '📋', to: '#', bs: true, bsNote: 'BS adds project + petty_cash_request links' },
  ...
  >
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-2 mb-4">
      ...
      >
        ...
        <div class="text-base font-semibold text-ink-900 mt-0.5 tabular-nums">{{ c.value }}</div>
