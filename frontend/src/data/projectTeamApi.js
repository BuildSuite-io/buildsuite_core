...
export const addProjectTeamMember = (project, user) =>
	call("add_project_team_member", { project, user });
export const removeProjectTeamMember = (project, user) =>
	call("remove_project_team_member", { project, user });
